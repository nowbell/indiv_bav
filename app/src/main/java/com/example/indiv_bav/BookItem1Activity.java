...
public class BookItem1Activity extends AppCompatActivity {
    Button back_btn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        back_btn = findViewById(R.id.book1_back_btn);
        back_btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent get_back = new Intent(BookItem1Activity.this, MainActivity.class);
                startActivity(get_back);
            }
        });

        audio_player = MediaPlayer.create(this, R.raw.audio1);
